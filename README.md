...
1. Create a new Dashboard (Settings → Dashboards → +) – give it a path like `apple-home` and switch it to YAML mode (Enable advanced mode in your profile if needed).
...
3. Save & refresh – the Home (My Home) view, Rooms, Groups, Scenes & Cameras generate automatically. Enter Edit mode to customize.
...
## 🆕 Recent Improvements (v1.1.3 & v1.1.3)
...
- **Drag & Drop**: Fixed section reorder drag and drop after v1.1.3 updates
